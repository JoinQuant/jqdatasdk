...
class MAC_TRADEVALUEENTERPRISE(Base):
    __tablename__ = "MAC_TRADEVALUEENTERPRISE"

    SGNMONTH = Column(String(14, u'utf8_bin'))
    DATASIGN = Column(String(4, u'utf8_bin'))
    TRADEWAYID = Column(String(20, u'utf8_bin'))
    ENTERPRISEID = Column(String(20, u'utf8_bin'))
