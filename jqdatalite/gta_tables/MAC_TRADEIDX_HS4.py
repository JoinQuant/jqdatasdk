...
class MAC_TRADEIDX_HS4(Base):
    __tablename__ = "MAC_TRADEIDX_HS4"

    SGNMONTH = Column(String(14, u'utf8_bin'))
    HS4ID = Column(BigInteger)
    IMPORTPRICEIDX = Column(Numeric(10, 4))
    IMPORTQUANTITYIDX = Column(Numeric(15, 4))
    IMPORTVALUEIDX = Column(Numeric(10, 4))
    EXPORTPRICEIDX = Column(Numeric(10, 4))
    EXPORTQUANTITYIDX = Column(Numeric(15, 4))
