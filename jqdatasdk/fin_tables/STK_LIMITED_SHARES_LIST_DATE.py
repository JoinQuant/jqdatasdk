...
class STK_LIMITED_SHARES_LIST_DATE(Base):

    __tablename__ = 'STK_LIMITED_SHARES_LIST_DATE'
    ...
    expected_unlimited_date = Column(Date, nullable=False, comment="预计解除限售日期")
    expected_unlimited_number = Column(DECIMAL(20, 4), comment="预计解除限售数量")
    expected_unlimited_ratio = Column(DECIMAL(20, 4), comment="预计解除限售比例")
    ...
    trade_condition = Column(String(500), comment="上市交易条件")
